...
;(function($, window, document) {
    ...
    function fnBindAll() {
        var $oneAll = $('#oneAll');
        var $twoAll = $('#twoAll');
        var $threeAll = $('#threeAll');
        var $fourAll = $('#fourAll');
        var $fiveAll = $('#fiveAll');
        var $sixAll = $('#sixAll');
        var $sevenAll = $('#sevenAll');
        var $eightAll = $('#eightAll');
        // 渲染 全部 模板
        var _data = {
        ...
        $oneAll.html(_html);$twoAll.html(_html);
        $threeAll.html(_html);$fourAll.html(_html);
        $fiveAll.html(_html);$sixAll.html(_html);
        $sevenAll.html(_html);$eightAll.html(_html);
    }
